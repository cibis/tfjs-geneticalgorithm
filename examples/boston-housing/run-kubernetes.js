...
async function testPredefinedModelsAgainstGA() {
    ...
    var taskSettings = {
        ...
        evolveGenerations: 10,
        elitesGenerations: 2,
        finalCloneCompetitionSize: 10,
    };

    var worker = new WorkerTraining(`job-tfjs-node-${utils.guidGenerator()}`, taskSettings.parallelism, taskSettings.modelTrainingTimeThreshold * 3);
        ...
        var ga = TFJSGeneticAlgorithmConstructor({
            ...
            modelTrainingFuction: async function (phenotype, model) {
                try {
                    ...
                    const modelJson = JSON.stringify(result);
            ...
            tensors: new DataService.DataSetSources(
                new DataService.DataSetSource("host.minikube.internal", "/boston-housing-training", "3000", "boston-housing-training", 333),
                new DataService.DataSetSource("host.minikube.internal", "/boston-housing-validation", "3000", "boston-housing-validation", 173)
            ),
